...
public class ODT2PDF implements DataFormatWriteOperation.OneToOne<OdfTextDocument, PDFDataFormat, Object> {
	...
	@Override
	public AsyncWork<Void, IOException> execute(OdfTextDocument input, Pair<Data,IO.Writable> output, Object params, byte priority, WorkProgress progress, long work) {
		Task<Void,IOException> task = new Task.Cpu<Void,IOException>("odt to pdf", priority) {
			@Override
