...
public class TestDisplayBMPSuiteBad {
	...
	public static void main(String[] args) {
		try {
			...
			URL url = TestDisplayBMPSuiteBad.class.getClassLoader().getResource("net/lecousin/dataformat/image/bmp/test/bmpsuite-2.5/b/badbitcount.bmp");
